        ...
        <nav className="flex items-center justify-between z-50 relative">
            ...
            {show ? (
                <div
                    ...
                    style={{ zIndex: "100" }}
                >
                    <div className="bg-[#eff1f5] flex items-start pt-12 md:pt-0 md:items-center justify-center w-full h-[75%] md:h-full md:w-2/3 lg:w-1/2 rounded-t-2xl md:rounded-none xl:w-[45%] 2xl:w-[35%] px-5 nd:px-8 relative">
                        <button
