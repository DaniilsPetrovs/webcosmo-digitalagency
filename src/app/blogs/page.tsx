    ...
    return (
        <>
            <main className="main blog" id="main">
                <div className="graident-main rounded-b-2xl rounded-tr-md rounded-tl-2xl md:rounded-2xl pt-8 pb-28 px-4 md:px-6 xl:px-8 2xl:px-0 overflow-hidden relative">
                    ...
                    <div className="container mx-auto">
                        ...
                        <div className="mt-8">
                            ...
                            <div className="mt-4 sm:mt-8 lg:mb-0 md:mb-26 mb-70">
                ...
                <div className="mt-4 md:mt-16 pt-18 md:pt-24 lg:pt-32 bg-[#eff1f5] rounded-2xl relative z-40 ">
                    <div className="absolute -top-[50px] left-1/2 -translate-x-1/2 w-full over bg-white pt-8 pb-4 md:py-8 2xl:py-12 rounded-xl md:rounded-2xl px-6 md:px-8 xl:px-12 2xl:px-16 max-w-[90%] md:max-w-[1100px] xl:max-w-[1300px] 2xl:max-w-[1600px] mx-auto -translate-y-5 md:-translate-y-10 flex justify-between">
                            ...
                            {options.map((item: string, i: number) => {
                                return (
                                    <div
                                        ...
                                        className="px-3 xl:px-4 w-fit !min-w-fit flex gap-2 rounded-lg md:rounded-xl py-3 blog-filter items-center justify-center  cursor-pointer border-1 border-black/10 transition-all"
                                    >
                        ...
                        <div className="flex flex-col items-end absolute -top-7 md:top-6 right-1/2 translate-x-[140px] md:translate-x-0 md:right-8 lg:relative w-[240px] 2xl:w-[250px]">
                            <Image
                                className="pointer-events-none absolute right-0 bottom-0 max-w-[165%] lg:max-w-[200%] xl:max-w-[185%] 2xl:max-w-[200%]"
                                src={blogs}
                                alt="image"
                            />

                            <p className="z-20 absolute bottom-24 max-w-[150px] md:max-w-[200px] lg:max-w-full xl:bottom-26 2xl:bottom-32 text-[12px] md:text-[12px] xl:text-[13px] 2xl:text-sm text-right right-4 text-white ">
                                {tr.telegramNote}
                            </p>
                    ...
                    <div className="cases-wrapper grid grid-cols-1 md:grid-cols-2 justify-items-center px-4 md:px-0 xl:grid-cols-3 gap-8 justify-center w-full max-w-[1600px] mx-auto">
                        {content}
                    </div>
